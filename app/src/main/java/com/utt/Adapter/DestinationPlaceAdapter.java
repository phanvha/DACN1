...
public class DestinationPlaceAdapter extends RecyclerView.Adapter<DestinationPlaceAdapter.PredictionHolder> implements Filterable {
    ...
    public interface OnShareClickedListener {
        public void ShareDesClicked(String url);
    }

    private ItemClickListener mItemClickListener;

    public DestinationPlaceAdapter(Context context, OnShareClickedListener onShareClickedListener) {
        mContext = context;
    ...
    public PredictionHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View convertView = layoutInflater.inflate(R.layout.layout_listview_place, viewGroup, false);
...
//        });
    ...
    public class PredictionHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        PredictionHolder(View itemView) {
            super(itemView);
            name = itemView.findViewById(R.id.txtNamePlace);
            address = itemView.findViewById(R.id.txtAddressPlace);
            mRow = itemView.findViewById(R.id.layout_place);
